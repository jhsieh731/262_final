...
def run_replicas(kind, replicas, script_name):
    ...
    for i, replica in enumerate(replicas, start = 3):
        ...
        if kind == "s1r":
            peers = ["10.0.0.144:5000","10.0.0.144:5001","10.0.0.144:5002"]
        elif kind == "s2r":
            peers = ["10.0.0.144:6000","10.0.0.144:6001","10.0.0.144:6002"]
        elif kind == "it":
            peers = ["10.0.0.144:7100","10.0.0.144:7101","10.0.0.144:7102"]
